...
export default defineQueue<UpdateSchedulerJobData, undefined, "fetch-latest-scheduler" | "refresh-all-scheduler" | "retry-failed-pages-scheduler" | "reindex-all-scheduler" | typeof QUEUE_NAME>({
	name: QUEUE_NAME,
	options: {
		defaultJobOptions: {
